...
To begin using the Veil Tipbot, you'll need to link all the accounts which are relevant to you. Starting in Discord, here are the command you can use to link Twitter and Reddit:
